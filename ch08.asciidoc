...
+nLocalServices+:: A list of local services supported by the node include:  +NODE_NETWORK+ +NODE_NETWORK_LIMITED+ +NODE_COMPACT_FILTERS+ +NODE_BLOOM+ +NODE_NETWORK+ +NODE_WITNESS+ +NODE_NONE+
